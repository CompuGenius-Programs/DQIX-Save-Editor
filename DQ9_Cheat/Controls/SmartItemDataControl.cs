...
namespace DQ9_Cheat.Controls
{
  public class SmartItemDataControl : DataControlBase
  {
    ...
    private void RenewalCollectionCount()
    {
      ...
      int num2 = (int) (smartItemData.CompCount / 944.0 * 100.0);
    ...
    private void panel_MouseDown(object sender, MouseEventArgs e)
    {
      ...
      SaveDataManager.Instance.SaveData.SmartItemData.SetSmartItemHold(_itemList[index2].DataIndex, _checkBox_Checked[index1]);
    ...
    private void comboBox_SelectType_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      _itemList = selectedIndex != 0 ? (selectedIndex >= 13 ? ItemDataList.GetList((ItemType) (selectedIndex - 10), null) : ItemDataList.GetWeaponList((WeaponType) (selectedIndex - 1))) : ItemDataList.GetAllSmartList();
      RenewalScrollBar();
      if (_updateCount != 0)
        return;
      SetSmartItemData();
