...
namespace DQ9_Cheat.Controls
{
  public class SmartItemDataControl : DataControlBase
  {
    ...
    public SmartItemDataControl()
    {
      ...
      this.Disposed += new EventHandler(this.SmartItemDataControl_Disposed);
    }
    ...
    {
      SmartItemData smartItemData = SaveDataManager.Instance.SaveData.SmartItemData;
      int num1 = 0;
      ...
      int num2 = (int) ((double) smartItemData.CompCount / 944.0 * 100.0);
      if (num2 == 0 && smartItemData.CompCount > (ushort) 0)
        num2 = 1;
    ...
    private void panel_MouseDown(object sender, MouseEventArgs e)
    {
      ...
      SaveDataManager.Instance.SaveData.SmartItemData.SetSmartItemHold(this._itemList[index2].DataIndex, this._checkBox_Checked[index1]);
      ...
      for (int index3 = 0; index3 < 12; ++index3)
      {
        for (int index4 = 0; index4 < 4; ++index4)
        {
          if (index2 < this._itemList.Length)
            this._checkBox_Checked[index1] = smartItemData.IsSmartItemHold(this._itemList[index2].DataIndex);
          ++index1;
          ++index2;
        }
      }
    ...
    private void button_AllCheck_Click(object sender, EventArgs e)
    {
      ...
      for (int index = 0; index < this._itemList.Length; ++index)
        SaveDataManager.Instance.SaveData.SmartItemData.SetSmartItemHold(this._itemList[index].DataIndex, true);
      SaveDataManager.Instance.SaveData.SmartItemData.ReviseCompCount();
      SaveDataManager.Instance.UndoRedoMgr.EndPluralEdit();
      this.OnValueUpdate();
    }
    ...
    private void button_AllUncheck_Click(object sender, EventArgs e)
    {
      SaveDataManager.Instance.UndoRedoMgr.BeginPluralEdit();
      for (int index = 0; index < this._itemList.Length; ++index)
        SaveDataManager.Instance.SaveData.SmartItemData.SetSmartItemHold(this._itemList[index].DataIndex, false);
      SaveDataManager.Instance.SaveData.SmartItemData.ReviseCompCount();
      SaveDataManager.Instance.UndoRedoMgr.EndPluralEdit();
      this.OnValueUpdate();
    }
    ...
    private void comboBox_SelectType_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      this._itemList = selectedIndex != 0 ? (selectedIndex >= 13 ? ItemDataList.GetList((ItemType) (selectedIndex - 10), (string) null) : ItemDataList.GetWeaponList((WeaponType) (selectedIndex - 1))) : ItemDataList.GetAllSmartList();
    ...
    private void InitializeComponent()
    {
      ...
      this.comboBox_SelectType.Items.AddRange(new object[20]
      {
        (object) "All",
        (object) "Swords",
        (object) "Spears",
      ...
      this.label1.Size = new Size(116, 12);
      this.label1.TabIndex = 7;
      this.label1.Text = "Completion Rate";
      this.label_CompRate.AutoSize = true;
      this.label_CompRate.Location = new Point(135, 11);
      ...
      this.Name = nameof (SmartItemDataControl);
