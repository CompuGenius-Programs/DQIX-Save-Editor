...
namespace DQ9_Cheat.Controls
{
  public class StayingListGroupBox : JS_GroupBox
  {
    ...
    private void _button_DeleteMap_Click(object sender, EventArgs e)
    {
      ...
      TreasureMapData treasureMapData = visitorManager.VisitorData[_selectedIndex].TreasureMapData;
    ...
    private void _numericUpDown_Place_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      TreasureMapData treasureMapData = SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].TreasureMapData;
    ...
    {
      if (_updateCount != 0 || _comboBox_Devil.SelectedIndex == -1 || !(_comboBox_Devil.SelectedItem is Devil selectedItem))
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].TreasureMapData.DevilType = selectedItem;
    }
    ...
    private void _numericUpDown_DevilLevel_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].TreasureMapData.DevilLevel.Value = (byte) _numericUpDown_DevilLevel.Value;
    }
    ...
    private void _numericUpDown_DevilVictoryTurn_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].TreasureMapData.DevilVictoryTurn = (ushort) _numericUpDown_DevilVictoryTurn.Value;
    }
    ...
    private void _checkBox_OpenProbability_CheckedChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || !(sender is CheckBox checkBox))
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].TreasureMapData.SetOpenProbability((int) checkBox.Tag, checkBox.Checked);
    }
    ...
    private void _comboBox_State_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].TreasureMapData.MapState = (MapState) (1 << _comboBox_State.SelectedIndex);
    }
    ...
    private void _panel_NormalMap_Paint(object sender, PaintEventArgs e)
    {
      using (Brush brush = new SolidBrush(SystemColors.ControlText))
      {
        ...
        if (_selectedIndex == -1 || !visitorManager.VisitorData[_selectedIndex].HaveTreasureMap)
          return;
        TreasureMapData treasureMapData = visitorManager.VisitorData[_selectedIndex].TreasureMapData;
        string s = !treasureMapData.IsValid ? string.Format("!{0}", treasureMapData.MapName) : treasureMapData.MapName;
    ...
    {
      VisitorManager visitorManager = SaveDataManager.Instance.SaveData.RikkaData.VisitorManager;
      using (HandleSelectWindow handleSelectWindow = new HandleSelectWindow(visitorManager.VisitorData[_selectedIndex].ProfileSex))
      {
        handleSelectWindow.Location = PointToScreen(new Point(_groupBox_Profile.Left + _buttonSelectHandle.Right, _groupBox_Profile.Top + _buttonSelectHandle.Bottom));
    ...
    private void _buttonSelectAddress_Click(object sender, EventArgs e)
    {
      ...
      {
        addressSelectWindow.Location = PointToScreen(new Point(_groupBox_Profile.Left + _buttonSelectAddress.Right, _groupBox_Profile.Top + _buttonSelectAddress.Bottom));
        if (addressSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].Address = addressSelectWindow.SelectedAddress;
        OnValueUpdate();
      }
    }
    ...
    private void _numericUpDownSEQ_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].SEQ = (uint) _numericUpDownSEQ.Value;
    }
    ...
    private void _numericUpDownUID_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      VisitorManager visitorManager = SaveDataManager.Instance.SaveData.RikkaData.VisitorManager;
      ulong num = (ulong) _numericUpDownUID.Value;
    ...
    private void _numericUpDownEyeColor_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].EyeColor = (byte) _numericUpDownEyeColor.Value;
    }
    ...
    private void _numericUpDownSkinColor_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].SkinColor = (byte) _numericUpDownSkinColor.Value;
    }
    ...
    private void _numericUpDownFaceType_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].FaceType.Value = (byte) _numericUpDownFaceType.Value;
    }
    ...
    private void _numericUpDownHairColor_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].HairColor.Value = (byte) _numericUpDownHairColor.Value;
    }
    ...
    private void _numericUpDownHairType_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].HairType.Value = (byte) _numericUpDownHairType.Value;
    }
    ...
    private void _numericUpDownFigureHeight_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].FigureHeight.Value = (ushort) _numericUpDownFigureHeight.Value;
    }
    ...
    private void _numericUpDownFigureWidth_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].FigureWidth.Value = (ushort) _numericUpDownFigureWidth.Value;
    }
    ...
    private void _numericUpDownBirthDayDay_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].ProfileBirthDay = (byte) _numericUpDownBirthDayDay.Value;
    }
    ...
    private void _numericUpDownBirthDayMonth_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].ProfileBirthMonth = (byte) _numericUpDownBirthDayMonth.Value;
    }
    ...
    private void _numericUpDownBirthDayYear_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].ProfileBirthYear = (ushort) _numericUpDownBirthDayYear.Value;
    }
    ...
    private void _comboBoxColor_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].Color = (byte) _comboBoxColor.SelectedIndex;
    }
    ...
    private void _textBox_ProfileMessage_TextChanged(object sender, EventArgs e)
    {
      ...
      byte[] bytes = templateencoding.GetBytes(_textBox_ProfileMessage.Text);
      ...
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].ProfileMessage.Value = _textBox_ProfileMessage.Text;
    }
    ...
    private void _checkBoxSecretAge_CheckedChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].ProfileSecretAge = _checkBoxSecretAge.Checked;
    }
    ...
    private void _profileTone_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].ProfileTone = (byte) _profileTone.SelectedIndex;
    }
    ...
    private void _numericUpDownAlchemyCompRate_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].AlchemyCompRate = (byte) _numericUpDownAlchemyCompRate.Value;
    }
    ...
    private void _numericUpDownItemCompRate_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].ItemCompRate = (byte) _numericUpDownItemCompRate.Value;
    }
    ...
    private void _numericUpDownFashionCompRate_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].FashionCompRate = (byte) _numericUpDownFashionCompRate.Value;
    }
    ...
    private void _numericUpDownMonsterCompRate_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].MonsterCompRate = (byte) _numericUpDownMonsterCompRate.Value;
    }
    ...
    private void _numericUpDownVisitorCount_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].VisitorCount = (ushort) _numericUpDownVisitorCount.Value;
    }
    ...
    private void _numericUpDownTreasureMapCount_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].TreasureMapCount = (ushort) _numericUpDownTreasureMapCount.Value;
    }
    ...
    private void _numericUpDownQuestClearCount_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].QuestClearCount = (ushort) _numericUpDownQuestClearCount.Value;
    }
    ...
    private void _numericUpDownTitleCount_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].TitleCount = (ushort) _numericUpDownTitleCount.Value;
    }
    ...
    private void _numericUpDownAlchemyCount_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].AlchemyCount = (ushort) _numericUpDownAlchemyCount.Value;
    }
    ...
    private void _numericUpDownVictoryCount_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].VictoryCount = (ushort) _numericUpDownVictoryCount.Value;
    }
    ...
    private void _numericUpDownMultiPlayTimeMinute_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].MultiPlayTimeMinute = (byte) _numericUpDownMultiPlayTimeMinute.Value;
    }
    ...
    private void _numericUpDownMultiPlayTimeHour_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].MultiPlayTimeHour = (ushort) _numericUpDownMultiPlayTimeHour.Value;
    }
    ...
    private void _numericUpDownPlayTimeMinute_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].PlayTimeMinute = (byte) _numericUpDownPlayTimeMinute.Value;
    }
    ...
    private void _numericUpDownPlayTimeHour_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].PlayTimeHour = (ushort) _numericUpDownPlayTimeHour.Value;
    }
    ...
    private void _numericUpDownTransmigration_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].Transmigration = (byte) _numericUpDownTransmigration.Value;
    }
    ...
    private void _numericUpDownLV_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].Level = (byte) _numericUpDownLV.Value;
    }
    ...
    private void _comboBoxPlace_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].Place = (byte) _comboBoxPlace.SelectedIndex;
    }
    ...
    private void _comboBoxJob_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].Job = (byte) JobDataList.List[_comboBoxJob.SelectedIndex].DataIndex;
    }
    ...
    private void _numericUpDownLodgingYear_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].LodgingDay_Year = (ushort) _numericUpDownLodgingYear.Value;
    }
    ...
    private void _numericUpDownLodgingMonth_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].LodgingDay_Month = (byte) _numericUpDownLodgingMonth.Value;
    }
    ...
    private void _numericUpDownLodgingDay_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || _selectedIndex == -1)
        return;
      SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].LodgingDay_Day = (byte) _numericUpDownLodgingDay.Value;
    }

    protected override void OnResize(EventArgs e) => _panelVisitorEditArea.Size = Size;
    ...
    public void OnValueUpdate() => OnValueUpdate(_selectedIndex);
    ...
    public void OnValueUpdate(int index)
    {
      ...
      if (_selectedIndex != -1)
      {
        ...
        VisitorData visitorData = visitorManager.VisitorData[_selectedIndex];
        ...
        _textBoxEquipmentWeapon.Text = visitorData.EquipmentWeapon == null ? "nothing" : visitorData.EquipmentWeapon.Name;
        _textBoxEquipmentShield.Text = visitorData.EquipmentShield == null ? "nothing" : visitorData.EquipmentShield.Name;
        _textBoxEquipmentHead.Text = visitorData.EquipmentHead == null ? "nothing" : visitorData.EquipmentHead.Name;
        _textBoxEquipmentUpperBody.Text = visitorData.EquipmentUpperBody == null ? "nothing" : visitorData.EquipmentUpperBody.Name;
        _textBoxEquipmentArm.Text = visitorData.EquipmentArm == null ? "nothing" : visitorData.EquipmentArm.Name;
        _textBoxEquipmentLowerBody.Text = visitorData.EquipmentLowerBody == null ? "nothing" : visitorData.EquipmentLowerBody.Name;
        _textBoxEquipmentShoe.Text = visitorData.EquipmentShoe == null ? "nothing" : visitorData.EquipmentShoe.Name;
        _textBoxEquipmentAccessory.Text = visitorData.EquipmentAccessory == null ? "nothing" : visitorData.EquipmentAccessory.Name;
    ...
    private void ButtonSelect_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(_groupBox_Equipment.Right, _groupBox_Equipment.Top + visionButton.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        ItemDataBase selectedItem = itemSelectWindow.SelectedItem;
        SaveDataManager.Instance.SaveData.RikkaData.VisitorManager.VisitorData[_selectedIndex].SetEquipment(itemType, selectedItem);
        OnValueUpdate();
      }
    }
    ...
    private void ButtonPreset_Click(object sender, EventArgs e)
    {
      ...
      {
        presetWindow.Location = PointToScreen(new Point(_groupBox_Figure.Right, _groupBox_Figure.Top + visionButton.Bottom));
