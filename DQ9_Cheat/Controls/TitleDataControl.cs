...
namespace DQ9_Cheat.Controls
{
  public class TitleDataControl : DataControlBase
  {
    ...
    private void panel_MouseDown(object sender, MouseEventArgs e)
    {
      ...
      int index2 = _vScrollBar.Value * 3 + index1;
    ...
    protected override void OnDataFileLoad() => _reviseCount = false;
    ...
    protected override void OnValueUpdate()
    {
      ...
      int index1 = 0;
      int index2 = _vScrollBar.Value * 3;
        ...
        using (Brush brush1 = new SolidBrush(ForeColor))
        {
          using (Brush brush2 = new SolidBrush(SystemColors.ControlLight))
          {
            using (Brush brush3 = new SolidBrush(SystemColors.Control))
            {
              ...
              int index1 = _vScrollBar.Value < _vScrollBar.Maximum - _vScrollBar.LargeChange ? _vScrollBar.Value * 3 : (_vScrollBar.Maximum - _vScrollBar.LargeChange - 1) * 3;
              int index2 = 0;
              int y = 25;
              for (int index3 = 0; index3 < 10; ++index3)
              {
                g.FillRectangle((index3 & 1) == 0 ? brush2 : brush3, new Rectangle(0, 20 + index3 * 35, panel.Width, 35));
                int x = 58;
                for (int index4 = 0; index4 < 3; ++index4)
                {
    ...
    private void TitleDataControl_Click(object sender, EventArgs e) => textBox_Dummy.Focus();
