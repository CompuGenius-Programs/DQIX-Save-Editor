...
namespace DQ9_Cheat.Controls
{
  public class CharacterDataControl : DataControlBase
  {
    ...
    private void InitializeComponent()
    {
      ...
      label26 = new Label();
      label27 = new Label();
      _numericUpDown_NowHP = new SafeNumericUpDown();
      _numericUpDown_NowMP = new SafeNumericUpDown();
      ...
      label39 = new Label();
      label35 = new Label();
      _numericUpDown_Experience = new SafeNumericUpDown();
      label30 = new Label();
      _numericUpDown_Level = new SafeNumericUpDown();
      label29 = new Label();
      ...
      _numericUpDown_NowHP.BeginInit();
      _numericUpDown_NowMP.BeginInit();
      ...
      _numericUpDown_Experience.BeginInit();
      _numericUpDown_Level.BeginInit();
      ...
      toolButton_PartyMemberDown.Image = (Image) componentResourceManager.GetObject("toolButton_PartyMemberDown.Image");
      ...
      toolButton_RuidaMemberDown.Image = (Image) componentResourceManager.GetObject("toolButton_RuidaMemberDown.Image");
      ...
      label27.TabIndex = 28;
      label27.Text = "MP";
      _numericUpDown_NowHP.Location = new Point(579, 17);
      _numericUpDown_NowHP.Name = "_numericUpDown_NowHP";
      _numericUpDown_NowHP.Size = new Size(48, 19);
      _numericUpDown_NowHP.TabIndex = 7;
      _numericUpDown_NowHP.Value = new Decimal(new int[4]);
      _numericUpDown_NowHP.ValueChanged += _numericUpDown_NowHP_ValueChanged;
      _numericUpDown_NowHP.Leave += _numericUpDown_NowHPMP_Leave;
      _numericUpDown_NowHP.Enter += _numericUpDown_NowHPMP_Enter;
      _numericUpDown_NowMP.Location = new Point(579, 42);
      _numericUpDown_NowMP.Name = "_numericUpDown_NowMP";
      _numericUpDown_NowMP.Size = new Size(48, 19);
      _numericUpDown_NowMP.TabIndex = 8;
      _numericUpDown_NowMP.Value = new Decimal(new int[4]);
      _numericUpDown_NowMP.ValueChanged += _numericUpDown_NowMP_ValueChanged;
      _numericUpDown_NowMP.Leave += _numericUpDown_NowHPMP_Leave;
      _numericUpDown_NowMP.Enter += _numericUpDown_NowHPMP_Enter;
      ...
      groupBox_Status.Controls.Add(_numericUpDown_Experience);
      groupBox_Status.Controls.Add(label30);
      groupBox_Status.Controls.Add(_numericUpDown_Level);
      ...
      _numericUpDown_Experience.Location = new Point(465, 69);
      _numericUpDown_Experience.Name = "_numericUpDown_Experience";
      _numericUpDown_Experience.Size = new Size(80, 19);
      _numericUpDown_Experience.TabIndex = 6;
      _numericUpDown_Experience.Value = new Decimal(new int[4]);
      _numericUpDown_Experience.ValueChanged += _numericUpDown_Experience_ValueChanged;
      ...
      label30.TabIndex = 39;
      label30.Text = "Exp.";
      _numericUpDown_Level.Location = new Point(403, 44);
      _numericUpDown_Level.Name = "_numericUpDown_Level";
      _numericUpDown_Level.Size = new Size(38, 19);
      _numericUpDown_Level.TabIndex = 4;
      _numericUpDown_Level.Value = new Decimal(new int[4]);
      _numericUpDown_Level.ValueChanged += _numericUpDown_Level_ValueChanged;
      ...
      Controls.Add(_numericUpDown_NowMP);
      Controls.Add(_numericUpDown_NowHP);
      ...
      _numericUpDown_NowHP.EndInit();
      _numericUpDown_NowMP.EndInit();
      ...
      _numericUpDown_Experience.EndInit();
      _numericUpDown_Level.EndInit();
    ...
    public SafeNumericUpDown NumericUpDown_Experience => _numericUpDown_Experience;

    public SafeNumericUpDown NumericUpDown_Level => _numericUpDown_Level;

    public SafeNumericUpDown NumericUpDown_NowHP => _numericUpDown_NowHP;

    public SafeNumericUpDown NumericUpDown_NowMP => _numericUpDown_NowMP;

    public VisionNumericUpDown NumericUpDown_Hair => _numericUpDown_Hair;

    public VisionNumericUpDown NumericUpDown_FigureHeight => _numericUpDown_FigureHeight;

    public VisionNumericUpDown NumericUpDown_FigureWidth => _numericUpDown_FigureWidth;

    public VisionNumericUpDown NumericUpDown_EyeColor => _numericUpDown_EyeColor;

    public VisionNumericUpDown NumericUpDown_SkinColor => _numericUpDown_SkinColor;

    public VisionNumericUpDown NumericUpDown_Face => _numericUpDown_Face;

    public VisionNumericUpDown NumericUpDown_HairColor => _numericUpDown_HairColor;

    public VisionNumericUpDown NumericUpDown_SkillPoint => _numericUpDown_SkillPoint;
    ...
    public void Initialize()
    {
      ...
      _numericUpDown_SkillPoint = new VisionNumericUpDown(87, 18, 56, 19);
      _numericUpDown_SkillPoint.ValueChanged += _numericUpDown_SkillPoint_ValueChanged;
      groupBox_Status.AddVisionControl(_numericUpDown_SkillPoint);
      int num1 = 1;
      int num2;
      _numericUpDown_FigureWidth = new VisionNumericUpDown(72, num2 = num1 + 21, 56, 19);
      _numericUpDown_FigureWidth.ValueChanged += _numericUpDown_FigureWidth_ValueChanged;
      groupBox_Figure.AddVisionControl(_numericUpDown_FigureWidth);
      int num3;
      _numericUpDown_FigureHeight = new VisionNumericUpDown(72, num3 = num2 + 21, 56, 19);
      _numericUpDown_FigureHeight.ValueChanged += _numericUpDown_FigureHeight_ValueChanged;
      groupBox_Figure.AddVisionControl(_numericUpDown_FigureHeight);
      int num4;
      _numericUpDown_Hair = new VisionNumericUpDown(72, num4 = num3 + 21, 56, 19);
      _numericUpDown_Hair.ValueChanged += _numericUpDown_Hair_ValueChanged;
      groupBox_Figure.AddVisionControl(_numericUpDown_Hair);
      int num5;
      _numericUpDown_HairColor = new VisionNumericUpDown(72, num5 = num4 + 21, 56, 19);
      _numericUpDown_HairColor.ValueChanged += _numericUpDown_HairColor_ValueChanged;
      groupBox_Figure.AddVisionControl(_numericUpDown_HairColor);
      int num6;
      _numericUpDown_Face = new VisionNumericUpDown(72, num6 = num5 + 21, 56, 19);
      _numericUpDown_Face.ValueChanged += _numericUpDown_Face_ValueChanged;
      groupBox_Figure.AddVisionControl(_numericUpDown_Face);
      int num7;
      _numericUpDown_SkinColor = new VisionNumericUpDown(72, num7 = num6 + 21, 56, 19);
      _numericUpDown_SkinColor.ValueChanged += _numericUpDown_SkinColor_ValueChanged;
      groupBox_Figure.AddVisionControl(_numericUpDown_SkinColor);
      int num8;
      _numericUpDown_EyeColor = new VisionNumericUpDown(72, num8 = num7 + 21, 56, 19);
      _numericUpDown_EyeColor.ValueChanged += _numericUpDown_EyeColor_ValueChanged;
      groupBox_Figure.AddVisionControl(_numericUpDown_EyeColor);
      int num9 = -4;
      int num10;
    ...
    protected override void OnValueUpdate() => RenewalControl();
    ...
    private void RenewalMemberListBox()
    {
      ...
      int num = 0;
      for (int index = 0; index < characterManager.CharacterStandbyCount && index < 12; ++index)
        listBox_StandbyMember.Items.Add(characterManager.CharacterData[num++].Name.Value);
      for (int index = 0; index < characterManager.PartyCharacterCount && num < 13; ++index)
    ...
    {
      BeginUpdate();
      CharacterData characterData = SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex];
      int dataIndex = JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex;
      _numericUpDown_Level.Value = characterData.JobLevel[dataIndex].Value;
      _numericUpDown_Experience.Value = characterData.JobExperience[dataIndex].Value;
    ...
    private void RenewalSkillSpecialtyListState()
    {
      ...
      if (comboBox_SkillSpecialty.SelectedItem is SkillData selectedItem)
      {
        ...
        {
          checkedListBox_Specialty.SetItemChecked(index1, characterManager.CharacterData[_selectedIndex].IsLearnSkillSpecialtyEffect(skillSpecialty.Index));
          ++index1;
        }
        int index2 = 0;
        foreach (SkillSpecialtyEffectData skillEffect in selectedItem.SkillEffectList)
        {
          checkedListBox_Skill.SetItemChecked(index2, characterManager.CharacterData[_selectedIndex].IsLearnSkillSpecialtyEffect(skillEffect.Index));
          ++index2;
        }
      }
      EndUpdate();
    ...
    protected override void RenewalControl()
    {
      ...
      CharacterData characterData = characterManager.CharacterData[_selectedIndex];
      ...
      RenewalJobStatus();
      _numericUpDown_NowHP.Value = characterData.NowHP;
      label_MaxHP.Text = string.Format("(Max HP {0})", characterData.MaxHP);
      _numericUpDown_NowMP.Value = characterData.NowMP;
      label_MaxMP.Text = string.Format("(Max MP {0})", characterData.MaxMP);
      _numericUpDown_FigureWidth.Value = characterData.FigureWidth.Value;
      _numericUpDown_FigureHeight.Value = characterData.FigureHeight.Value;
      _numericUpDown_Hair.Value = characterData.HairType.Value;
      _numericUpDown_HairColor.Value = characterData.HairColor.Value;
      _numericUpDown_Face.Value = characterData.FaceType.Value;
      _numericUpDown_SkinColor.Value = characterData.SkinColor;
      _numericUpDown_EyeColor.Value = characterData.EyeColor;
      _numericUpDown_SkillPoint.Value = characterData.SkillPoint.Value;
      ...
      if (_selectedIndex >= characterManager.CharacterStandbyCount)
      {
        ...
        {
          ItemDataBase tool = itemData.GetTool(_selectedIndex - characterManager.CharacterStandbyCount, toolIndex);
    ...
    {
      CharacterManager characterManager = SaveDataManager.Instance.SaveData.CharacterManager;
      if (listBox_PartyMember.SelectedIndex >= characterManager.PartyCharacterCount - 1 || listBox_PartyMember.SelectedIndex == -1)
        return;
    ...
    {
      CharacterManager characterManager = SaveDataManager.Instance.SaveData.CharacterManager;
      if (listBox_StandbyMember.SelectedIndex >= characterManager.CharacterStandbyCount - 1 || listBox_StandbyMember.SelectedIndex == -1)
        return;
    ...
    {
      CharacterManager characterManager = SaveDataManager.Instance.SaveData.CharacterManager;
      int selectedIndex = listBox_StandbyMember.SelectedIndex;
      if (selectedIndex == -1 || MessageBox.Show(string.Format("キャラクター「{0}」を削除します。\nよろしいですか？", characterManager.CharacterData[selectedIndex].Name.Value), "确定", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
        return;
    ...
    private void _numericUpDown_FigureWidth_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].FigureWidth.Value = (ushort) _numericUpDown_FigureWidth.Value;
    }
    ...
    private void _numericUpDown_FigureHeight_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].FigureHeight.Value = (ushort) _numericUpDown_FigureHeight.Value;
    }
    ...
    private void _numericUpDown_Hair_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].HairType.Value = (byte) _numericUpDown_Hair.Value;
    }
    ...
    private void _numericUpDown_HairColor_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].HairColor.Value = (byte) _numericUpDown_HairColor.Value;
    }
    ...
    private void _numericUpDown_Face_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].FaceType.Value = (byte) _numericUpDown_Face.Value;
    }
    ...
    private void _numericUpDown_SkinColor_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SkinColor = (byte) _numericUpDown_SkinColor.Value;
    }
    ...
    private void _numericUpDown_EyeColor_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].EyeColor = (byte) _numericUpDown_EyeColor.Value;
    }
    ...
    private void button_FigurePreset_Click(object sender, EventArgs e)
    {
      ...
      {
        presetWindow.Location = PointToScreen(new Point(groupBox_Figure.Right, groupBox_Figure.Top + button_FigurePreset.Bottom));
    ...
    private void button_HairPreset_Click(object sender, EventArgs e)
    {
      ...
      {
        presetWindow.Location = PointToScreen(new Point(groupBox_Figure.Right, groupBox_Figure.Top + button_HairPreset.Bottom));
        if (presetWindow.ShowDialog() != DialogResult.OK || !(presetWindow.SelectedPreset is Preset selectedPreset))
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].HairType.Value = selectedPreset.Index;
        RenewalControl();
      }
    }
    ...
    private void button_HairColorPreset_Click(object sender, EventArgs e)
    {
      ...
      {
        presetWindow.Location = PointToScreen(new Point(groupBox_Figure.Right, groupBox_Figure.Top + button_HairColorPreset.Bottom));
        if (presetWindow.ShowDialog() != DialogResult.OK || !(presetWindow.SelectedPreset is Preset selectedPreset))
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].HairColor.Value = selectedPreset.Index;
        RenewalControl();
      }
    }
    ...
    private void button_FacePreset_Click(object sender, EventArgs e)
    {
      ...
      {
        presetWindow.Location = PointToScreen(new Point(groupBox_Figure.Right, groupBox_Figure.Top + button_FacePreset.Bottom));
        if (presetWindow.ShowDialog() != DialogResult.OK || !(presetWindow.SelectedPreset is Preset selectedPreset))
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].FaceType.Value = selectedPreset.Index;
        RenewalControl();
      }
    }
    ...
    private void button_SelectWeapon_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(groupBox_Equipment.Right, groupBox_Equipment.Top + button_SelectWeapon.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].EquipmentWeapon = itemSelectWindow.SelectedItem;
        RenewalControl();
      }
    }
    ...
    private void button_SelectShield_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(groupBox_Equipment.Right, groupBox_Equipment.Top + button_SelectShield.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].EquipmentShield = itemSelectWindow.SelectedItem;
        RenewalControl();
      }
    }
    ...
    private void button_SelectHead_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(groupBox_Equipment.Right, groupBox_Equipment.Top + button_SelectHead.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].EquipmentHead = itemSelectWindow.SelectedItem;
        RenewalControl();
      }
    }
    ...
    private void button_SelectUpperBody_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(groupBox_Equipment.Right, groupBox_Equipment.Top + button_SelectUpperBody.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].EquipmentUpperBody = itemSelectWindow.SelectedItem;
        RenewalControl();
      }
    }
    ...
    private void button_SelectArm_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(groupBox_Equipment.Right, groupBox_Equipment.Top + button_SelectArm.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].EquipmentArm = itemSelectWindow.SelectedItem;
        RenewalControl();
      }
    }
    ...
    private void button_SelectLowerBody_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(groupBox_Equipment.Right, groupBox_Equipment.Top + button_SelectLowerBody.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].EquipmentLowerBody = itemSelectWindow.SelectedItem;
        RenewalControl();
      }
    }
    ...
    private void button_SelectShoe_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(groupBox_Equipment.Right, groupBox_Equipment.Top + button_SelectShoe.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].EquipmentShoe = itemSelectWindow.SelectedItem;
        RenewalControl();
      }
    }
    ...
    private void button_SelectAccessory_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(groupBox_Equipment.Right, groupBox_Equipment.Top + button_SelectAccessory.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].EquipmentAccessory = itemSelectWindow.SelectedItem;
        RenewalControl();
      }
    }
    ...
    private void comboBox_Sex_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].Sex = (byte) comboBox_Sex.SelectedIndex;
    }
    ...
    private void comboBox_Job_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].Job.Value = (byte) JobDataList.List[comboBox_Job.SelectedIndex].DataIndex;
    }
    ...
    private void _numericUpDown_SkillPoint_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SkillPoint.Value = (ushort) _numericUpDown_SkillPoint.Value;
    }
    ...
    private void comboBox_Color_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].Color = (byte) comboBox_Color.SelectedIndex;
    }
    ...
    private void comboBox_Rank_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].Rank = (byte) comboBox_Rank.SelectedIndex;
    }
    ...
    private void comboBox_Strategy_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].Strategy = comboBox_Strategy.SelectedItem as Strategy;
    }
    ...
    private void button_SelectTools_Click(object sender, EventArgs e)
    {
      ...
      {
        itemSelectWindow.Location = PointToScreen(new Point(groupBox_Tool.Right, groupBox_Tool.Top + visionButton.Bottom));
        if (itemSelectWindow.ShowDialog() != DialogResult.OK)
          return;
        ItemDataBase selectedItem = itemSelectWindow.SelectedItem;
        SaveDataManager.Instance.SaveData.ItemData.SetTool(_selectedIndex - SaveDataManager.Instance.SaveData.CharacterManager.CharacterStandbyCount, (int) visionButton.Tag, selectedItem);
        RenewalControl();
      }
    }
    ...
    private void NumericUpDown_Skill_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0 || !(sender is VisionNumericUpDown visionNumericUpDown))
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].JobSkillLevel[JobDataList.GetJobData(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex).SkillList[(int) visionNumericUpDown.Tag].Index].Value = (byte) visionNumericUpDown.Value;
    }
    ...
    private void _numericUpDown_NowHP_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].NowHP = (ushort) _numericUpDown_NowHP.Value;
    }
    ...
    private void _numericUpDown_NowMP_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].NowMP = (ushort) _numericUpDown_NowMP.Value;
    }
    ...
    private void _numericUpDown_Level_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].JobLevel[JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex].Value = (byte) _numericUpDown_Level.Value;
    }
    ...
    private void _numericUpDown_Experience_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].JobExperience[JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex].Value = (uint) _numericUpDown_Experience.Value;
    }
    ...
    private void _numericUpDown_ReviseHP_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetReviseMaxHP(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (ushort) _numericUpDown_ReviseHP.Value);
    }
    ...
    private void _numericUpDown_ReviseMP_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetReviseMaxMP(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (ushort) _numericUpDown_ReviseMP.Value);
    }
    ...
    private void _numericUpDown_RevisePower_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetRevisePower(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (ushort) _numericUpDown_RevisePower.Value);
    }
    ...
    private void _numericUpDown_ReviseFacility_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetReviseFacility(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (ushort) _numericUpDown_ReviseFacility.Value);
    }
    ...
    private void _numericUpDown_ReviseQuick_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetReviseQuick(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (ushort) _numericUpDown_ReviseQuick.Value);
    }
    ...
    private void _numericUpDown_ReviseDefense_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetReviseDefense(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (ushort) _numericUpDown_ReviseDefense.Value);
    }
    ...
    private void _numericUpDown_ReviseAttackMagic_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetReviseAttackMagic(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (ushort) _numericUpDown_ReviseAttackMagic.Value);
    }
    ...
    private void _numericUpDown_ReviseRevivalMagic_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetReviseRevivalMagic(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (ushort) _numericUpDown_ReviseRevivalMagic.Value);
    }
    ...
    private void _numericUpDown_ReviseSmart_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetReviseSmart(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (ushort) _numericUpDown_ReviseSmart.Value);
    }
    ...
    private void _numericUpDown_Transmigration_ValueChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetTransmigration(JobDataList.List[comboBox_StatusEditJob.SelectedIndex].DataIndex, (byte) _numericUpDown_Transmigration.Value);
    }
    ...
    private void checkedListBox_Specialty_ItemCheck(object sender, ItemCheckEventArgs e)
    {
      ...
      if (!(checkedListBox_Specialty.Items[e.Index] is SkillSpecialtyEffectData specialtyEffectData))
        return;
      characterManager.CharacterData[_selectedIndex].SetLearnSkillSpecialtyEffect(specialtyEffectData.Index, e.NewValue == CheckState.Checked);
    }
    ...
    private void checkBox_Ruler_CheckedChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetLearnRular(checkBox_Ruler.Checked);
    }
    ...
    private void checkBox_Cheer_CheckedChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].SetLearnCheer(checkBox_Cheer.Checked);
    }
    ...
    private void checkBox_Poison_CheckedChanged(object sender, EventArgs e)
    {
      if (_updateCount != 0)
        return;
      SaveDataManager.Instance.SaveData.CharacterManager.CharacterData[_selectedIndex].Poison = checkBox_Poison.Checked;
    }
