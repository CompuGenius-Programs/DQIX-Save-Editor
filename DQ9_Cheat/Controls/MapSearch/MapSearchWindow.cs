...
namespace DQ9_Cheat.Controls.MapSearch
{
  public class MapSearchWindow : Form
  {
    ...
    private ComparerBase[] _comparer = new ComparerBase[22]
    {
      new SeedComparer(),
      new RankComparer(),
      new MapNameComparer(),
    ...
    {
      int index = e.ItemIndex - _dispStartIndex;
      if (index < 0)
        index = 0;
    ...
    private void listView_Result_CacheVirtualItems(object sender, CacheVirtualItemsEventArgs e)
    {
      ...
      if (!_dispRenewal && _dispItems != null && _dispStartIndex <= e.StartIndex && _dispStartIndex + _dispItems.Length > e.EndIndex || length <= 0)
        return;
      _dispRenewal = false;
      ...
      {
        SearchDungeonData resultData = _resultDatas[startIndex];
    ...
    private void listView_Result_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      {
        int index = _listViewItemSelection[0];
    ...
    private void RenewalDungeonDetail(bool disp)
    {
      if (disp)
      {
        ...
        for (int index = 0; index < SearchDataFile.RankList.Length; ++index)
        {
          ...
          {
            num1 = index != SearchDataFile.RankList.Length - 1 ? (byte) (SearchDataFile.RankList[index + 1] - 1U) : (byte) 248;
            break;
          }
        }
        stringBuilder.AppendFormat("Rank: 0x{0:X2} - 0x{1:X2}, Seed: 0x{2:X4}\n", _treasureMapDetailData.MapRank, num1, _treasureMapDetailData.MapSeed);
        ...
        if (_treasureMapDetailData.MapRank <= 50 && num1 > 50)
        {
          ...
          foreach (byte lowRankValidPlace in _treasureMapDetailData.LowRankValidPlaceList)
            stringBuilder.AppendFormat(" 0x{0:X2}({1})", lowRankValidPlace, TreasureMapDataTable.TreasureMapPlaceName_Table[TreasureMapDataTable.TreasureMapPlace_Table[lowRankValidPlace]]);
          stringBuilder.Append("\n");
          stringBuilder.Append("Locations up to Rank 0x37:");
          foreach (byte middleRankValidPlace in _treasureMapDetailData.MiddleRankValidPlaceList)
            stringBuilder.AppendFormat(" 0x{0:X2}({1})", middleRankValidPlace, TreasureMapDataTable.TreasureMapPlaceName_Table[TreasureMapDataTable.TreasureMapPlace_Table[middleRankValidPlace]]);
        }
        else
        {
          stringBuilder.Append("Locations:");
          foreach (byte validPlace in _treasureMapDetailData.ValidPlaceList)
            stringBuilder.AppendFormat(" 0x{0:X2}({1})", validPlace, TreasureMapDataTable.TreasureMapPlaceName_Table[TreasureMapDataTable.TreasureMapPlace_Table[validPlace]]);
        }
        stringBuilder.Append("\n");
        ...
        int treasureBoxCount = _treasureMapDetailData.GetTreasureBoxCount(0);
        ...
        if (treasureBoxCount > 0)
        {
          ...
          for (int rank = 10; rank > 0; --rank)
            stringBuilder.AppendFormat(" {0}:{1}", _treasureBoxRankSymbol[0, rank - 1], _treasureMapDetailData.GetTreasureBoxCount(rank));
          stringBuilder.Append("\n");
          stringBuilder.Append(" By floor:\n");
          for (int floor = 0; floor < _treasureMapDetailData.FloorCount; ++floor)
          {
            if (_treasureMapDetailData.GetTreasureBoxCountPerFloor(floor) > 0)
            {
              stringBuilder.AppendFormat("   B{0:D2}:", floor + 1);
              foreach (TreasureBoxInfo treasureBoxInfo in _treasureMapDetailData.TreasureBoxInfoList[floor])
        ...
        for (int floor = 0; floor < _treasureMapDetailData.FloorCount; ++floor)
        {
          ...
          byte[,] floorMap = _treasureMapDetailData.GetFloorMap(floor);
          if (floorMap != null)
          {
            stringBuilder.Append("\n");
            stringBuilder.AppendFormat("B{0:D2}\n", floor + 1);
            for (int y = 0; y < _treasureMapDetailData.GetFloorHeight(floor); ++y)
            {
              for (int x = 0; x < _treasureMapDetailData.GetFloorWidth(floor); ++x)
              {
                ...
                {
                  int num2 = _treasureMapDetailData.IsTreasureBoxRank(floor, x, y);
                  if (num2 > 0)
                  {
                    int treasureBoxIndex = _treasureMapDetailData.GetTreasureBoxIndex(floor, x, y);
            ...
            {
              int rank = _treasureMapDetailData.TreasureBoxInfoList[floor][index1].Rank;
              int index2 = _treasureMapDetailData.TreasureBoxInfoList[floor][index1].Index;
              string treasureBoxItem = _treasureMapDetailData.GetTreasureBoxItem(floor, index2, 2);
              stringBuilder.AppendFormat("({0:D2}, {1:D2}) {2} {3}\n", _treasureMapDetailData.TreasureBoxInfoList[floor][index1].X, _treasureMapDetailData.TreasureBoxInfoList[floor][index1].Y, _treasureBoxRankSymbol[1, rank - 1], treasureBoxItem);
            }
          }
        }
        ...
        {
          for (int index3 = 0; index3 < _treasureMapDetailData.FloorCount; ++index3)
          {
    ...
    private void textBox_DungeonDetail_MouseMove(object sender, MouseEventArgs e)
    {
      ...
      for (int index1 = 0; index1 < _treasureMapDetailData.FloorCount; ++index1)
      {
    ...
    private void textBox_DungeonDetail_MouseDown(object sender, MouseEventArgs e)
    {
      ...
      for (int floor = 0; floor < _treasureMapDetailData.FloorCount; ++floor)
      {
        for (int boxIndex = 0; boxIndex < _treasureBoxCount[floor]; ++boxIndex)
        {
          ...
          {
            textBox_DungeonDetail.Cursor = Cursors.Arrow;
            using (TreasureBoxItemTableList boxItemTableList = new TreasureBoxItemTableList(_treasureMapDetailData, floor, boxIndex))
            {
              foreach (TreasureBoxInfo treasureBoxInfo in _treasureMapDetailData.TreasureBoxInfoList[floor])
              {
    ...
    private class ABoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        ...
        return _up ? searchDungeonData1.ABoxCount - searchDungeonData2.ABoxCount : searchDungeonData2.ABoxCount - searchDungeonData1.ABoxCount;
      }
    }
    ...
    private class BBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.BBoxCount - searchDungeonData2.BBoxCount : searchDungeonData2.BBoxCount - searchDungeonData1.BBoxCount;
      }
    }
    ...
    private class BossComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.Boss - searchDungeonData2.Boss : searchDungeonData2.Boss - searchDungeonData1.Boss;
      }
    }
    ...
    private class CBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.CBoxCount - searchDungeonData2.CBoxCount : searchDungeonData2.CBoxCount - searchDungeonData1.CBoxCount;
      }
    }
    ...
    private class DBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.DBoxCount - searchDungeonData2.DBoxCount : searchDungeonData2.DBoxCount - searchDungeonData1.DBoxCount;
      }
    }
    ...
    private class DepthComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.Depth - searchDungeonData2.Depth : searchDungeonData2.Depth - searchDungeonData1.Depth;
      }
    }
    ...
    private class EBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.EBoxCount - searchDungeonData2.EBoxCount : searchDungeonData2.EBoxCount - searchDungeonData1.EBoxCount;
      }
    }
    ...
    private class FBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.FBoxCount - searchDungeonData2.FBoxCount : searchDungeonData2.FBoxCount - searchDungeonData1.FBoxCount;
      }
    }
    ...
    private class GBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.GBoxCount - searchDungeonData2.GBoxCount : searchDungeonData2.GBoxCount - searchDungeonData1.GBoxCount;
      }
    }
    ...
    private class HBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.HBoxCount - searchDungeonData2.HBoxCount : searchDungeonData2.HBoxCount - searchDungeonData1.HBoxCount;
      }
    }
    ...
    private class IBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.IBoxCount - searchDungeonData2.IBoxCount : searchDungeonData2.IBoxCount - searchDungeonData1.IBoxCount;
      }
    }
    ...
    private class MapLVComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.MapLevel - searchDungeonData2.MapLevel : searchDungeonData2.MapLevel - searchDungeonData1.MapLevel;
      }
    }
    ...
    private class MapName1Comparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.MapName1Index - searchDungeonData2.MapName1Index : searchDungeonData2.MapName1Index - searchDungeonData1.MapName1Index;
      }
    }
    ...
    private class MapName2Comparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.MapName2Index - searchDungeonData2.MapName2Index : searchDungeonData2.MapName2Index - searchDungeonData1.MapName2Index;
      }
    }
    ...
    private class MapName3Comparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.MapName3Index - searchDungeonData2.MapName3Index : searchDungeonData2.MapName3Index - searchDungeonData1.MapName3Index;
      }
    }
    ...
    private class MapNameComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        int num1 = searchDungeonData1.MapName1Index + (searchDungeonData1.MapName2Index << 5) + (searchDungeonData1.MapName3Index << 10) + (searchDungeonData1.MapLevel << 15);
        int num2 = searchDungeonData2.MapName1Index + (searchDungeonData2.MapName2Index << 5) + (searchDungeonData2.MapName3Index << 10) + (searchDungeonData2.MapLevel << 15);
    ...
    private class MapTypeComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.MapType - searchDungeonData2.MapType : searchDungeonData2.MapType - searchDungeonData1.MapType;
      }
    }
    ...
    private class MonsterRankComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.MonsterRank - searchDungeonData2.MonsterRank : searchDungeonData2.MonsterRank - searchDungeonData1.MonsterRank;
      }
    }
    ...
    private class RankComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.Rank - searchDungeonData2.Rank : searchDungeonData2.Rank - searchDungeonData1.Rank;
      }
    }
    ...
    private class SBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.SBoxCount - searchDungeonData2.SBoxCount : searchDungeonData2.SBoxCount - searchDungeonData1.SBoxCount;
      }
    }
    ...
    private class SeedComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.Seed - searchDungeonData2.Seed : searchDungeonData2.Seed - searchDungeonData1.Seed;
      }
    }
    ...
    private class TotalBoxComparer : ComparerBase, IComparer
    {
      public override int Compare(object x, object y)
      {
        SearchDungeonData searchDungeonData1 = (SearchDungeonData) x;
        SearchDungeonData searchDungeonData2 = (SearchDungeonData) y;
        return _up ? searchDungeonData1.TotalBoxCount - searchDungeonData2.TotalBoxCount : searchDungeonData2.TotalBoxCount - searchDungeonData1.TotalBoxCount;
      }
    }
  }
}
