...
namespace DQ9_Cheat.GameData
{
  internal static class ItemDataList
  {
    ...
    private static int _maxSmartIndex;
    private static int _maxItemCollectionIndex;
    ...
    static ItemDataList()
    {
      ...
      _maxSmartIndex = dataIndex1 - 1;
      int dataIndex2 = 7;
      InitializeToolDataList(ref dataIndex2);
      InitializeImportantDataList(ref dataIndex2);
      _maxItemCollectionIndex = dataIndex2 - 1;
    }

    public static int MaxSmartndex => _maxSmartIndex;

    public static int MaxItemCollectionIndex => _maxItemCollectionIndex;
    ...
    {
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20004, "Copper sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20005, "Soldier's sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 0, true, ItemType.Weapon, WeaponType.Sword, 20000, "Warrior's sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20003, "Rapier"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 3, true, ItemType.Weapon, WeaponType.Sword, 20009, "Fizzle foil"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20006, "Iron broadsword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 1, true, ItemType.Weapon, WeaponType.Sword, 20007, "Steel broadsword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 2, true, ItemType.Weapon, WeaponType.Sword, 20008, "Gigasteel broadsword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20010, "Cautery sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 4, true, ItemType.Weapon, WeaponType.Sword, 20011, "Aurora blade"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 5, true, ItemType.Weapon, WeaponType.Sword, 20012, "Platinum sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20001, "Bandit blade"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20002, "Valkyrie sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20013, "Dragonsbane"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 6, true, ItemType.Weapon, WeaponType.Sword, 20014, "Dragon slayer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20015, "Falcon blade"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 7, true, ItemType.Weapon, WeaponType.Sword, 20016, "Über falcon blade"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20017, "Miracle sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 8, true, ItemType.Weapon, WeaponType.Sword, 20018, "Über miracle sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 9, true, ItemType.Weapon, WeaponType.Sword, 20019, "Fire blade"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 10, true, ItemType.Weapon, WeaponType.Sword, 20020, "Inferno blade"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20021, "Metal slime sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 11, true, ItemType.Weapon, WeaponType.Sword, 20022, "Liquid metal sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 12, true, ItemType.Weapon, WeaponType.Sword, 20023, "Metal king sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Sword, 20024, "Rusty sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 13, true, ItemType.Weapon, WeaponType.Sword, 20025, "Erdrick's sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 14, true, ItemType.Weapon, WeaponType.Sword, 20026, "Stardust sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 15, true, ItemType.Weapon, WeaponType.Sword, 20027, "Nebula sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 16, true, ItemType.Weapon, WeaponType.Sword, 20028, "Supernova sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 17, false, ItemType.Weapon, WeaponType.Sword, 20029, "Hypernova sword"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Spear, 20500, "Bamboo lance"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Spear, 20503, "Iron lance"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 18, true, ItemType.Weapon, WeaponType.Spear, 20504, "Steel lance"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 19, true, ItemType.Weapon, WeaponType.Spear, 20505, "Gigasteel lance"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Spear, 20506, "Long spear"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 20, true, ItemType.Weapon, WeaponType.Spear, 20501, "Celestial spear"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 21, true, ItemType.Weapon, WeaponType.Spear, 20507, "Holy lance"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Spear, 20508, "Battle fork"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 22, true, ItemType.Weapon, WeaponType.Spear, 20509, "Trident"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 23, true, ItemType.Weapon, WeaponType.Spear, 20510, "Grace's trident"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 25, true, ItemType.Weapon, WeaponType.Spear, 20511, "Sandstorm spear"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 26, true, ItemType.Weapon, WeaponType.Spear, 20513, "Lightning lance"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 27, true, ItemType.Weapon, WeaponType.Spear, 20514, "Storm spear"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 28, true, ItemType.Weapon, WeaponType.Spear, 20515, "Demon spear"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Spear, 20516, "Hero spear"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Spear, 20517, "Metal slime spear"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 29, true, ItemType.Weapon, WeaponType.Spear, 20518, "Liquid metal spear"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 30, true, ItemType.Weapon, WeaponType.Spear, 20519, "Metal king spear"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 31, true, ItemType.Weapon, WeaponType.Spear, 20520, "Poker"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 32, true, ItemType.Weapon, WeaponType.Spear, 20521, "Stud poker"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 33, true, ItemType.Weapon, WeaponType.Spear, 20522, "Split-pot poker"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 34, false, ItemType.Weapon, WeaponType.Spear, 20523, "Red-hot poker"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Dagger, 19050, "Paring knife"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Dagger, 19051, "Bronze knife"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 35, true, ItemType.Weapon, WeaponType.Dagger, 19052, "Divine dagger"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 36, true, ItemType.Weapon, WeaponType.Dagger, 19053, "Poison moth knife"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 37, true, ItemType.Weapon, WeaponType.Dagger, 19054, "Batterfly knife"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 38, true, ItemType.Weapon, WeaponType.Dagger, 19055, "Dread dagger"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 39, true, ItemType.Weapon, WeaponType.Dagger, 19057, "Poison needle"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Dagger, 19061, "Deadly nightblade"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 44, true, ItemType.Weapon, WeaponType.Dagger, 19064, "Falcon knife earring"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 40, true, ItemType.Weapon, WeaponType.Dagger, 19058, "Assassin's dagger"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 41, true, ItemType.Weapon, WeaponType.Dagger, 19059, "Icicle dirk"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 42, true, ItemType.Weapon, WeaponType.Dagger, 19060, "Fenrir fang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Dagger, 19062, "Sword breaker"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 43, true, ItemType.Weapon, WeaponType.Dagger, 19063, "Soul breaker"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 45, true, ItemType.Weapon, WeaponType.Dagger, 19065, "Gladius"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 46, true, ItemType.Weapon, WeaponType.Dagger, 19066, "Flame tang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Dagger, 19067, "Pruning knife"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 47, true, ItemType.Weapon, WeaponType.Dagger, 19068, "Deft dagger"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 48, true, ItemType.Weapon, WeaponType.Dagger, 19069, "Darting dagger"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 49, true, ItemType.Weapon, WeaponType.Dagger, 19070, "Dashing dagger"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 50, false, ItemType.Weapon, WeaponType.Dagger, 19071, "Dynamo dagger"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Wand, 20403, "Oak staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Wand, 20494, "Wizard's staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 51, true, ItemType.Weapon, WeaponType.Wand, 20404, "Staff of sentencing"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 52, true, ItemType.Weapon, WeaponType.Wand, 20405, "Staff of divine wrath"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Wand, 20406, "Stolos' staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 56, true, ItemType.Weapon, WeaponType.Wand, 20408, "Watermaul wand"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 57, true, ItemType.Weapon, WeaponType.Wand, 20409, "Tsunami staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 53, true, ItemType.Weapon, WeaponType.Wand, 20495, "Lightning staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 54, true, ItemType.Weapon, WeaponType.Wand, 20407, "Lightning conductor"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 55, true, ItemType.Weapon, WeaponType.Wand, 20496, "Magma staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Wand, 20419, "Faerie staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Wand, 20402, "Brouhaha boomstick"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 58, true, ItemType.Weapon, WeaponType.Wand, 20410, "Rune staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 59, true, ItemType.Weapon, WeaponType.Wand, 20400, "Hieroglyph staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Wand, 20493, "Magical mace"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 60, true, ItemType.Weapon, WeaponType.Wand, 20411, "Mega-magical mace"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Wand, 20412, "Sceptre of Gitt"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Wand, 20401, "Sage's staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 61, true, ItemType.Weapon, WeaponType.Wand, 20413, "Savant's staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Wand, 20414, "Wyrmwand"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 62, true, ItemType.Weapon, WeaponType.Wand, 20415, "Bright staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 63, true, ItemType.Weapon, WeaponType.Wand, 20416, "Shining staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 64, true, ItemType.Weapon, WeaponType.Wand, 20417, "Brilliant staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 65, false, ItemType.Weapon, WeaponType.Wand, 20418, "Aurora staff"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Whip, 20300, "Leather whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Whip, 20301, "Thorn whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Whip, 20302, "Battle whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 66, true, ItemType.Weapon, WeaponType.Whip, 20303, "Snakeskin whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 67, true, ItemType.Weapon, WeaponType.Whip, 20304, "Serpentine whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 68, true, ItemType.Weapon, WeaponType.Whip, 20305, "Sidewinder"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Whip, 20306, "Chain whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Whip, 20307, "Iron whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 69, true, ItemType.Weapon, WeaponType.Whip, 20308, "Spiked steel whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 70, true, ItemType.Weapon, WeaponType.Whip, 20309, "Gigaspike whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 71, true, ItemType.Weapon, WeaponType.Whip, 20310, "Dragontail whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 72, true, ItemType.Weapon, WeaponType.Whip, 20311, "Demon whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 73, true, ItemType.Weapon, WeaponType.Whip, 20312, "Archdemon whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 74, true, ItemType.Weapon, WeaponType.Whip, 20313, "Scourge whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Whip, 20314, "Queen's whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 75, true, ItemType.Weapon, WeaponType.Whip, 20315, "Empress's whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 76, true, ItemType.Weapon, WeaponType.Whip, 20316, "Goddess whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Whip, 20317, "Wizadly whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 77, true, ItemType.Weapon, WeaponType.Whip, 20318, "Gringham whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 78, true, ItemType.Weapon, WeaponType.Whip, 20319, "Mega Gringham Whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 79, true, ItemType.Weapon, WeaponType.Whip, 20320, "Giga Gringham whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 80, false, ItemType.Weapon, WeaponType.Whip, 20321, "Über Gringham whip"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Club, 20600, "Laundry pole"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Club, 20601, "Carrying pole"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Club, 20602, "Oaken pole"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 82, true, ItemType.Weapon, WeaponType.Club, 20605, "Gigasteel bar"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 83, true, ItemType.Weapon, WeaponType.Club, 20606, "Pillar of strength"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Club, 20609, "Driller pillar"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 85, true, ItemType.Weapon, WeaponType.Club, 20610, "Killer pillar"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Club, 20607, "Sleepy stick"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 84, true, ItemType.Weapon, WeaponType.Club, 20608, "Slumber stick"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 86, true, ItemType.Weapon, WeaponType.Club, 20611, "Mistick"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 87, true, ItemType.Weapon, WeaponType.Club, 20612, "Optimistick"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Club, 20615, "Dragon rod"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 89, true, ItemType.Weapon, WeaponType.Club, 20616, "Xenlon rod"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 90, true, ItemType.Weapon, WeaponType.Club, 20617, "Orichalcudgel"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 91, true, ItemType.Weapon, WeaponType.Club, 20618, "Knockout rod"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 92, true, ItemType.Weapon, WeaponType.Club, 20619, "Senseless stick"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 93, true, ItemType.Weapon, WeaponType.Club, 20620, "Catatonic cosh"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 94, false, ItemType.Weapon, WeaponType.Club, 20621, "Coma cudgel"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Crow, 20800, "Stone claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Crow, 20801, "Iron claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 95, true, ItemType.Weapon, WeaponType.Crow, 20802, "Steel claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 96, true, ItemType.Weapon, WeaponType.Crow, 20803, "Gigasteel claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Crow, 20805, "Razor claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 97, true, ItemType.Weapon, WeaponType.Crow, 20804, "Sacred claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Crow, 20806, "Crow's claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 98, true, ItemType.Weapon, WeaponType.Crow, 20807, "Kestrel claws"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 100, true, ItemType.Weapon, WeaponType.Crow, 20810, "Hammer handrills"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Crow, 20811, "Dragon claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 101, true, ItemType.Weapon, WeaponType.Crow, 20812, "Fire claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 102, true, ItemType.Weapon, WeaponType.Crow, 20813, "Combusticlaws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Crow, 20814, "Cobra claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 103, true, ItemType.Weapon, WeaponType.Crow, 20815, "King cobra claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Crow, 20816, "Beast claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 104, true, ItemType.Weapon, WeaponType.Crow, 20817, "Beastmaster claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 105, true, ItemType.Weapon, WeaponType.Crow, 20818, "Orichalcum claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 106, true, ItemType.Weapon, WeaponType.Crow, 20819, "Dragonlord claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 107, true, ItemType.Weapon, WeaponType.Crow, 20820, "Dragovian claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 108, true, ItemType.Weapon, WeaponType.Crow, 20821, "Dragovian lord claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 109, false, ItemType.Weapon, WeaponType.Crow, 20822, "Xenion claws"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Fan, 20100, "Feather fan"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 111, true, ItemType.Weapon, WeaponType.Fan, 20103, "Gigasteel fan"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 113, true, ItemType.Weapon, WeaponType.Fan, 20106, "Gale force fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 120, true, ItemType.Weapon, WeaponType.Fan, 20113, "Cobra fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 121, true, ItemType.Weapon, WeaponType.Fan, 20114, "Azure Dragon fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 118, true, ItemType.Weapon, WeaponType.Fan, 20111, "Fowl fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 119, true, ItemType.Weapon, WeaponType.Fan, 20112, "Vermillion Bird fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 116, true, ItemType.Weapon, WeaponType.Fan, 20109, "Feline fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 117, true, ItemType.Weapon, WeaponType.Fan, 20110, "White Tiger fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 114, true, ItemType.Weapon, WeaponType.Fan, 20107, "Tortoiseshell fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 115, true, ItemType.Weapon, WeaponType.Fan, 20108, "Black Tortoise fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Fan, 20115, "Stellar fan"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Fan, 20124, "White bouquet"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 124, true, ItemType.Weapon, WeaponType.Fan, 20118, "Friendly fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Fan, 20119, "Attribeauty"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 125, true, ItemType.Weapon, WeaponType.Fan, 20120, "Critical fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 126, true, ItemType.Weapon, WeaponType.Fan, 20121, "Overcritical fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, sbyte.MaxValue, true, ItemType.Weapon, WeaponType.Fan, 20122, "Hypercritical fan"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 128, false, ItemType.Weapon, WeaponType.Fan, 20123, "Dire critical fan"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 130, true, ItemType.Weapon, WeaponType.Axe, 20203, "Gigasteel axe"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 133, true, ItemType.Weapon, WeaponType.Axe, 20206, "Full moon axe"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Axe, 20208, "Headsman's axe"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 136, true, ItemType.Weapon, WeaponType.Axe, 20209, "Executioner's axe"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 137, true, ItemType.Weapon, WeaponType.Axe, 20210, "Ice axe"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 138, true, ItemType.Weapon, WeaponType.Axe, 20211, "Avalanche axe"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Axe, 20212, "Heavy hatchet"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 142, false, ItemType.Weapon, WeaponType.Axe, 20216, "Galaxy axe"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Hammer, 19150, "Oaken club"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 143, true, ItemType.Weapon, WeaponType.Hammer, 19151, "Ace of clubs"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Hammer, 19152, "Sledgehammer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Hammer, 19153, "War hammer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 144, true, ItemType.Weapon, WeaponType.Hammer, 19154, "Über war hammer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Hammer, 19155, "Giant wrench"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 145, true, ItemType.Weapon, WeaponType.Hammer, 19156, "Terra tamper"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 146, true, ItemType.Weapon, WeaponType.Hammer, 19157, "Terra firmer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 147, true, ItemType.Weapon, WeaponType.Hammer, 19158, "Terra hammer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Hammer, 19159, "Marauder's maul"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Hammer, 19161, "Giant's hammer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 148, true, ItemType.Weapon, WeaponType.Hammer, 19162, "Titan's hammer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Hammer, 19160, "Hela's hammer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 149, true, ItemType.Weapon, WeaponType.Hammer, 19163, "Megaton hammer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 150, true, ItemType.Weapon, WeaponType.Hammer, 19164, "Warlord's hammer"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 151, true, ItemType.Weapon, WeaponType.Hammer, 19165, "Groundbreaker"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 152, true, ItemType.Weapon, WeaponType.Hammer, 19166, "Earthsplitter"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 153, true, ItemType.Weapon, WeaponType.Hammer, 19167, "Moonmasher"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 154, false, ItemType.Weapon, WeaponType.Hammer, 19168, "Starsmasher"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Boomerang, 20700, "Boomerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 155, true, ItemType.Weapon, WeaponType.Boomerang, 20701, "Reinforced boomerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Boomerang, 20702, "Edged boomerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 156, true, ItemType.Weapon, WeaponType.Boomerang, 20703, "Cutting-edge boomerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 157, true, ItemType.Weapon, WeaponType.Boomerang, 20704, "Crucerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Boomerang, 20705, "Razor-wing boomerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 158, true, ItemType.Weapon, WeaponType.Boomerang, 20706, "Razer-wing boomerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 159, true, ItemType.Weapon, WeaponType.Boomerang, 20707, "Erazor-wing boomerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Boomerang, 20708, "Swallowtail"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 160, true, ItemType.Weapon, WeaponType.Boomerang, 20709, "Eaglewing"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 161, true, ItemType.Weapon, WeaponType.Boomerang, 20710, "Gustarang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 162, true, ItemType.Weapon, WeaponType.Boomerang, 20711, "Blusterang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 163, true, ItemType.Weapon, WeaponType.Boomerang, 20712, "Flametang boomerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 164, true, ItemType.Weapon, WeaponType.Boomerang, 20713, "Banefire boomerang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 165, true, ItemType.Weapon, WeaponType.Boomerang, 20714, "Pentarang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 166, true, ItemType.Weapon, WeaponType.Boomerang, 20715, "Hexarang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 167, true, ItemType.Weapon, WeaponType.Boomerang, 20716, "Meteorang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 168, true, ItemType.Weapon, WeaponType.Boomerang, 20717, "Asterang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 169, true, ItemType.Weapon, WeaponType.Boomerang, 20718, "Stellarang"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 170, false, ItemType.Weapon, WeaponType.Boomerang, 20719, "Galaxarang"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 172, true, ItemType.Weapon, WeaponType.Bow, 20903, "Hunter's bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Bow, 20904, "Fuddle bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Bow, 20900, "Potshot bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 173, true, ItemType.Weapon, WeaponType.Bow, 20906, "Hotshot bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 174, true, ItemType.Weapon, WeaponType.Bow, 20907, "Blowy bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 175, true, ItemType.Weapon, WeaponType.Bow, 20908, "Billowing bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 176, true, ItemType.Weapon, WeaponType.Bow, 20909, "Blustery bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Bow, 20905, "Cheiron's bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.Weapon, WeaponType.Bow, 20910, "Great bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 177, true, ItemType.Weapon, WeaponType.Bow, 20911, "Purblind bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 178, true, ItemType.Weapon, WeaponType.Bow, 20912, "Blinding bow"));
      ...
      _weaponList.Add(new ItemDataBase(dataIndex++, 181, true, ItemType.Weapon, WeaponType.Bow, 20915, "Angel's bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 182, true, ItemType.Weapon, WeaponType.Bow, 20916, "Archangel's bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 183, true, ItemType.Weapon, WeaponType.Bow, 20917, "Aeon's bow"));
      _weaponList.Add(new ItemDataBase(dataIndex++, 184, false, ItemType.Weapon, WeaponType.Bow, 20918, "Seraph's bow"));
    ...
    private static void InitializeUpperBodyDataList(ref int dataIndex)
    {
      ...
      _upperBodyList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.UpperBody, 13162, "Dragon warrior armour"));
      ...
      _upperBodyList.Add(new ItemDataBase(dataIndex++, byte.MaxValue, true, ItemType.UpperBody, 13020, "Twinkling tuxedo"));
      ...
      _upperBodyList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.UpperBody, 13700, "Fizzle-retardant suit"));
      _upperBodyList.Add(new ItemDataBase(dataIndex++, 268, true, ItemType.UpperBody, 13701, "Fizzle-proof suit"));
      _upperBodyList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.UpperBody, 13600, "Fizzle-retardant blouse"));
      ...
      _upperBodyList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.UpperBody, 13626, "Santa's little helper suit"));
    ...
    private static void InitializeLowerBodyDataList(ref int dataIndex)
    {
      ...
      _lowerBodyList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.LowerBody, 16303, "Dangerous midriff wrap"));
      _lowerBodyList.Add(new ItemDataBase(dataIndex++, 290, true, ItemType.LowerBody, 16304, "Hot bikini bottoms"));
      _lowerBodyList.Add(new ItemDataBase(dataIndex++, 291, true, ItemType.LowerBody, 16305, "Sizzling bikini bottoms"));
      _lowerBodyList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.LowerBody, 16256, "Dragon warrior trousers"));
      ...
      _lowerBodyList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.LowerBody, 16259, "White tuxedo trousers"));
      ...
      _lowerBodyList.Add(new ItemDataBase(dataIndex++, -1, false, ItemType.LowerBody, 16248, "Fleurette's chaussettes"));
    ...
    {
      List<ItemDataBase> list = GetList(itemType);
      if (list == null)
        return null;
      if (search == null)
        return list.ToArray();
    ...
    {
      List<ItemDataBase> itemDataBaseList = new List<ItemDataBase>();
      foreach (ItemDataBase alchemyWeapon in _alchemyWeaponList)
      {
    ...
    {
      List<ItemDataBase> itemDataBaseList = new List<ItemDataBase>();
      foreach (ItemDataBase weapon in _weaponList)
      {
    ...
    public static ItemDataBase GetItem(ushort itemValue)
    {
      ...
      {
        List<ItemDataBase> list = GetList((ItemType) index);
        if (list != null)
        {
          foreach (ItemDataBase itemDataBase in list)
          {
