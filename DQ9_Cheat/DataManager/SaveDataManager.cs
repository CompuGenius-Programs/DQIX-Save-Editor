...
namespace DQ9_Cheat.DataManager
{
  internal class SaveDataManager
  {
    ...
    public UndoRedoManager UndoRedoMgr => _undoRedoManger;
    ...
    public unsafe void WriteData(BinaryWriter bw)
    {
      ...
      for (int index = 0; index < 2; ++index)
      {
        ...
        uint num1 = crc32(_saveData[index].Data, 20, 16);
        uint num2 = crc32(_saveData[index].Data, 136, 28508);
    ...
    public void CopyIntermissionData(int srcIndex)
    {
      ...
      byte[] data = _saveData[srcIndex].GetData();
