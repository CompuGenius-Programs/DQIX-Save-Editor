...
namespace DQ9_Cheat.DataManager
{
  internal class WifiShopping
  {
    ...
    private WifiShopGoods[] _wifiShopGoods = new WifiShopGoods[6];
    ...
    public WifiShopping(SaveData owner)
    {
      ...
      for (int index = 0; index < 6; ++index)
        _wifiShopGoods[index] = new WifiShopGoods(owner, index);
    }
    ...
    public ushort ExpiresYear
    {
      ...
      set
      {
        _expiresDateTime.Value = (uint) ((int) _expiresDateTime.Value & -4096 | value & 4095);
      }
    }
    ...
    public byte ExpiresMonth
    {
      ...
      set
      {
        _expiresDateTime.Value = (uint) ((int) _expiresDateTime.Value & -61441 | value << 12 & 61440);
      }
    }
    ...
    public byte ExpiresDay
    {
      ...
      set
      {
        _expiresDateTime.Value = (uint) ((int) _expiresDateTime.Value & -2031617 | value << 16 & 2031616);
      }
    }
    ...
    public byte ExpiresHour
    {
      ...
      set
      {
        _expiresDateTime.Value = (uint) ((int) _expiresDateTime.Value & -65011713 | value << 21 & 65011712);
      }
    }
    ...
    public ushort AllowNextConnectYear
    {
      ...
      set
      {
        _allowNextConnectDateTime.Value = (uint) ((int) _allowNextConnectDateTime.Value & -4096 | value & 4095);
      }
    }
    ...
    public byte AllowNextConnectMonth
    {
      ...
      set
      {
        _allowNextConnectDateTime.Value = (uint) ((int) _allowNextConnectDateTime.Value & -61441 | value << 12 & 61440);
      }
    }
    ...
    public byte AllowNextConnectDay
    {
      ...
      set
      {
        _allowNextConnectDateTime.Value = (uint) ((int) _allowNextConnectDateTime.Value & -2031617 | value << 16 & 2031616);
      }
    }
    ...
    public byte AllowNextConnectHour
    {
      ...
      set
      {
        _allowNextConnectDateTime.Value = (uint) ((int) _allowNextConnectDateTime.Value & -65011713 | value << 21 & 65011712);
      }
    }

    public WifiShopGoods[] WifiShopGoods => _wifiShopGoods;
    ...
    public ushort MessageExpiresYear
    {
      ...
      set
      {
        _messageExpiresDateTime.Value = (uint) ((int) _messageExpiresDateTime.Value & -4096 | value & 4095);
      }
    }
    ...
    public byte MessageExpiresMonth
    {
      ...
      set
      {
        _messageExpiresDateTime.Value = (uint) ((int) _messageExpiresDateTime.Value & -61441 | value << 12 & 61440);
      }
    }
    ...
    public byte MessageExpiresDay
    {
      ...
      set
      {
        _messageExpiresDateTime.Value = (uint) ((int) _messageExpiresDateTime.Value & -2031617 | value << 16 & 2031616);
      }
    }
    ...
    public byte MessageExpiresHour
    {
      ...
      set
      {
        _messageExpiresDateTime.Value = (uint) ((int) _messageExpiresDateTime.Value & -65011713 | value << 21 & 65011712);
      }
    }
